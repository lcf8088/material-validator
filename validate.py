...
Usage:
    ...
    ./validate.py --manual --spec <spec-id>         # Manual entry mode
    ./validate.py --extract-prompt                   # Print extraction prompt
...
def main():
    ...
    input_group.add_argument('--manual', action='store_true',
                             help='Interactive manual data entry mode')
    ...
    extract_group.add_argument('--extract-prompt', action='store_true',
                               help='Print the extraction prompt for vision LLM')
